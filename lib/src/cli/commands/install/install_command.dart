...
// import 'package:tachyon/src/cli/commands/install/install_arguments.dart';
...
//   }) {
//     argParser.addArgumentOptions(InstallArgumentOption.options);
//   }
...
//     final String path = argResults![InstallArgumentOption.path.name] ?? Directory.current.path;
